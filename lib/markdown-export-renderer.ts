...
`;
  ...
  private renderQASlideMarkdown(slide: PresentationSlide): string {
    return `**Slide Type:** Q&A Slide
...
### Completed Issues
${this.formatIssuesList(allIssues.filter(issue => isIssueCompleted(issue.status)))}
